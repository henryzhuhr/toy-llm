...
def _load_model(pretrained_model_name_or_path):
    bnb_config = BitsAndBytesConfig(  # pip install bitsandbytes
        ...
        bnb_4bit_compute_dtype=torch.bfloat16,  # Sets the computational data type for the 4-bit quantized model, controlling precision during inference or training.
    )
